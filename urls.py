...
urlpatterns = [
    ...
    path('vendors/<int:pk>/performance/', VendorPerformanceEndpoint.as_view(), name='vendor-performance'),
    path('purchase_orders/<int:pk>/acknowledge/', UpdateAcknowledgmentEndpoint.as_view(), name='acknowledge-purchase-order'),
]